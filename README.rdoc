...
send data, using json, or hessian here.

hessian2 2.0 implements hessian 2.0 protocol. involve {web services protocol}[http://hessian.caucho.com/doc/hessian-ws.html] and {serialization protocol}[http://hessian.caucho.com/doc/hessian-serialization.html].
...
the field names are only serialized once, efficient.
