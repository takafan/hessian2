...
msgpack: pack/unpack fastest.

hessian2: any object, referencable, serialize field names once and following objects only values, therefore smallest, saving transfer.
